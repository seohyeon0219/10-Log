...
export default function AppLayout() {
  return (
    <>
      ...
      <div aria-hidden="true" className="pointer-events-none fixed -right-20 -bottom-20 -z-10 h-[320px] w-[320px] rounded-full opacity-40" style={{ background: 'var(--color-blob-apricot)', filter: 'blur(85px)' }} />
