          ...
          <div>
            ...
            <div className="grid gap-1.5">
              {topExpenses.map((tx, i) => (
                <div
                  className="flex items-center gap-2.5 rounded-[14px] bg-black/[0.04] px-3 py-2.5"
                  key={tx.id}
                >
