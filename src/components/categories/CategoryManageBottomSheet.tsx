        ...
        <div className="mx-auto w-full max-w-2xl">
          ...
          <section className="mt-7">
            ...
            <div className="grid gap-1">
              {activeItems.map((category) => (
                <div
                  className="flex min-h-14 items-center gap-3 rounded-xl px-2 active:bg-gray-50"
                  key={category.id}
                >
                  <span
                  ...
                  <button
                    className="cursor-pointer rounded-lg px-2 py-1 text-sm font-bold text-gray-400 active:bg-gray-100 active:text-black"
                  ...
                  <button
                    className="cursor-pointer rounded-lg px-2 py-1 text-sm font-bold text-gray-400 active:bg-gray-100 active:text-(--color-expense-red)"
